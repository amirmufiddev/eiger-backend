...
Jelaskan ringkasan dari perubahan yang dilakukan dan masalah apa yang diperbaiki. Lampirkan tautan ke tiket atau isu yang terkait jika ada .
...
Masukan kode pada masalah terkait (misalnya, `OP#123`) dalam hal ini kita menggunakan open project.
...
Jelaskan lingkungan pengembangan yang digunakan untuk pengujian:

- OS: [misalnya, Windows 10, Ubuntu 18.04]
